        ...
        return (
            <div key={index} className="flex gap-2 mt-4 ">
                ...
                <div className="max-w-[70%]">
                    <h1 className="text-[#F0F4FA] text-opacity-90 font-bold text-md" >{year}</h1>
                    {info[indexactive].description[index].map(pr => 
                        <p className="text-[#F0F4FA] text-opacity-80 text-sm mb-4">{pr}</p>
                    )}
                </div>
    ...
    return (
        <div className="bg-cover bg-lightgray bg-[url('/MyHistoryImgs/BgMyHistory.png')] py-12 flex justify-center ">
            ...
            <div className="flex w-[90%] justify-between">
                ...
                <div className="w-full mr-10 mt-20 rounded-2xl bg-[#000] bg-opacity-70 shadow-[6px_6px_10px_0px_rgba(255,2,2,0.5)] pt-10 pr-4">
                    <h1 className="text-[#F0F4FA] text-md font-bold max-w-[90%] text-justify">{info[indexactive].header}</h1>
                    {infoHtml}
                </div>
